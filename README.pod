...
=head1 SYNOPSIS
    ...
    say $christmas->day->name; #String representation of the name of the day in the liturgical calendar; e.g. 'Christmas Day'
    say $christmas->year->name; #String representation of the name of the liturgical year; e.g. 'C'
    say ${$christmas->readings}[0] #String representation of the first reading for the day.
...
alt: The alternative name --- if one is given --- of the day in the lectionary.  For noLect days a String representation of the day is returned as the alternative name.
